...
(function (e) {
    ...
    e(window).load(function () {
        e("#content_1").mCustomScrollbar({scrollButtons: {enable: true}, theme: "dark"});
        e(".inner-noslit").mCustomScrollbar({scrollButtons: {enable: true}, theme: "dark"});
        e(".models-scroll").mCustomScrollbar({scrollButtons: {enable: true}, theme: "dark"});
        e("a[rel='load-content']").click(function (t) {
            t.preventDefault();
            var n = e(this), r = n.attr("href");
            n.addClass("loading");
            e.get(r, function (t) {
                n.removeClass("loading");
                e("#content_1 .mCSB_container").html(t);
                e("#content_1").mCustomScrollbar("update");
                e("#content_1").mCustomScrollbar("scrollTo", "top", {scrollInertia: 200})
            })
        });
